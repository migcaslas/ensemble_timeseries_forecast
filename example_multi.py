...
# Load-adapt multivariate data
start_date = '2013-01-01 00:00:00'
data_df = pandas.read_csv('multivariante.csv')
...
train_test_size_per = 0.01  # WARNING! Training and testing size is reduced for example purposes. Set to 1
...
exp_model_params = {"seasonal": "multiplicative", "seasonal_periods": 24}
